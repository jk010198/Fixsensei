...
public class order_samsung {
    ...
    public order_samsung() {
    }

    public order_samsung(String id, String device_name, String model_name, String issue, String date, String name,String mobile_color,
